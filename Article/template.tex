...
\Figure{0.85\textwidth}{images/PLL.png}{Схема классической системы ФАПЧ, где $\operatorname{sin} (\theta_{ref}(t))$~--- опорный сигнал с фазой $\theta_{ref}(t)$, $\operatorname{cos} (\theta_{vco}(t))$~--- сигнал ГУН с фазой $\theta_{vco}(t)$}
