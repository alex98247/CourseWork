...
\end{equation}
 ...
 \begin{equation}
 \begin{aligned}
&-\varepsilon + 1 - \delta + (- \alpha_2 + 2\alpha_2\delta - \alpha_1^2\delta - \alpha_1^2 \beta_1^2\varepsilon - \beta_2\alpha_2 + 2\beta_2\alpha_2\varepsilon + \alpha_1^2\beta_1)t + \\
+& (\beta_2\alpha_2^2 - \beta_2^2\alpha_2^2\varepsilon - \alpha_2^2\delta)t^2 \geq 0
 \end{aligned}
\end{equation}
Тогда первое условие теоремы принимает вид:
