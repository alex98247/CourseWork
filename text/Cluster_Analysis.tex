...
Тогда первое условие теоремы принимает вид:
 \begin{equation}
 \begin{aligned}
&-\varepsilon + \varkappa - \delta + (- \alpha_2\varkappa + 2\alpha_2\delta - \alpha_1^2\delta - \alpha_1^2 \beta_1^2\varepsilon - \beta_2\alpha_2\varkappa + 2\beta_2\alpha_2\varepsilon + \alpha_1^2\beta_1\varkappa)t + \\
+& (\beta_2\alpha_2^2\varkappa - \beta_2^2\alpha_2^2\varepsilon - \alpha_2^2\delta)t^2 \geq 0
 \end{aligned}
\end{equation}
Не умаляя общности положим $\varkappa = 1$:
 \begin{equation}
 \begin{aligned}
&(\beta_2\alpha_2^2 - \beta_2^2\alpha_2^2\varepsilon - \alpha_2^2\delta)t^2 + (- \alpha_2 + 2\alpha_2\delta - \alpha_1^2\delta - \alpha_1^2 \beta_1^2\varepsilon - \beta_2\alpha_2 + 2\beta_2\alpha_2\varepsilon + \alpha_1^2\beta_1)t +\\
&  + 1 -\varepsilon - \delta  \geq 0
 \end{aligned}
\end{equation}
