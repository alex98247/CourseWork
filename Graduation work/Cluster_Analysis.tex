...
\draw[->] (-4,0) -- (a.west) node[midway,above,inner sep=2pt] {sin($\theta_{ref}(t)$)};
\draw[->] (a.east) -- (loop_filter.west) node[midway,above,inner sep=2pt] {sin($\theta_{e}(t)$)};
\draw[->] (loop_filter.east) -- (VCO.west) node[midway,above,inner sep=2pt] {$\upsilon_f(t)$};
\draw[->] (VCO.east) -- (14.5,0) node[midway,above,inner sep=2pt] {cos($\theta_{vco}(t)$)};
\draw[->] (14,0) --  +(0,-2) --  +(-13.5,-2) --  (a.south);
