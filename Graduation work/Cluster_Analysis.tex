...
Заметим, что 
 \begin{equation}
 \begin{aligned}
\alpha_2^2\beta_2 - \alpha_2^2\delta - \alpha_2^2\beta_2^2 + \alpha_2^2\beta_2^2\delta \geq 0
 \end{aligned}
\end{equation}
Для того что бы выполнялось \eqref{filter3-3} нужно потребовать, что бы выполнялось следущее условие
 \begin{equation}
 \begin{aligned}
